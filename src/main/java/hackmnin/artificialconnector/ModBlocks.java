...
public class ModBlocks {
  ...
  public static final DeferredRegister<Block> BLOCKS =
      DeferredRegister.create(Registries.BLOCK, ArtificialConnectorMod.MOD_ID);
   ...
   */
  public static final DeferredHolder<Block, Block> ARTIFICIAL_ORE = registerBlock("artificial_ore",
      () -> new ArtificialOreBlock(
   ...
   */
  public static final DeferredHolder<Block, Block> CONNECTOR_BLOCK =
      registerBlock(
          "connector_block",
          () -> new ConnectorBlock(
  ...
  private static <T extends Block> DeferredHolder<Block, T> registerBlock(String name,
    ...
    ModItems.ITEMS.register(name,
        () -> new BlockItem(blockHolder.get(), new Item.Properties().rarity(rarity)));
    return blockHolder;
  }
