...
public class ModCreativeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, ArtificialConnectorMod.MODID);
            ...
            CREATIVE_MODE_TABS.register("artificial_connector_tab",
                    () -> CreativeModeTab.builder()
                            ...
                            .displayItems((displayParameters, output) -> {
                                ...
                                output.accept(ModItems.ARTIFICIAL_NUGGET.get());
                                output.accept(ModItems.RAW_ARTIFICIAL_ORE.get());
                                output.accept(ModItems.ARTIFICIAL_WRENCH.get());
