...
public class ModItems {
  ...
  public static final DeferredRegister<Item> ITEMS =
      DeferredRegister.create(Registries.ITEM, ArtificialConnectorMod.MOD_ID);
  ...
  /**
   * Registers all items with the mod's event bus. This method is called from the main mod class
   * constructor.
   *
