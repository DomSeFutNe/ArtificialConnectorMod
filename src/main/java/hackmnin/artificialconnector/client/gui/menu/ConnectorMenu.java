package hackmnin.artificialconnector.client.gui.menu;

import hackmnin.artificialconnector.ModBlocks;
import hackmnin.artificialconnector.ModMenuTypes;
...
public class ConnectorMenu extends AbstractContainerMenu {
  ...
  public ConnectorMenu(int containerId, Inventory inv, BlockEntity entity) {
    ...
    // Add the fuel slot
    this.addSlot(new SlotItemHandler(blockEntity.capability, 0, 80, 106));
  }
